      ...
      <div className="mx-auto max-w-[1332px]">
        ...
        <div className="flex flex-col xl:flex-row my-20 px-4 lg:px mx-auto w-fit xl:items-start items-center  gap-14">
          ...
          <div className="flex flex-col sm:flex-row gap-12">
            <div className="flex sm:flex-row flex-col gap-3">
              {comparison.map((product: Product) => (
                <div key={product._id}>
                  <div className="bg-[#F9F1E7] h-[197px] w-[260px] rounded-lg flex justify-center items-center mx-auto">
                  ...
                  <div className="text-center w-[260px] sm:text-left">
                    ...
                    <span className="flex gap-2">
                      <button
                        className="bg-gray-700 w-[160px] h-8 text-white rounded-lg hover:bg-gray-800"
                        type="button"
                        onClick={() => {
                      ...
                      <button
                        className="bg-yellow-700 w-[160px] h-8 text-white rounded-lg hover:bg-yellow-800"
                        type="button"
                        onClick={() => {
          ...
          <div className="flex flex-col gap-2 xl:items-start items-center mt-16">
            ...
            <button
              className="w-[242px] h-[39px] flex items-center text-white font-medium justify-between px-4 rounded-md bg-[#B88E2F] hover:bg-[#be9942]"
              type="button"
              onClick={() => {
        ...
        <div className="flex max-w-[1332px] px-4 mb-28 sm:flex-row flex-col sm:gap-0 gap-4">
          <div className="flex flex-col gap-24 sm:border-r border-t border-1 w-72 md:pl-10 pl-1 pt-8">
            <span className="space-y-7 ">
              <h6 className="font-poppins font-medium md:text-[28px]/[35px] text-xl">
                General
              </h6>
              <p className="font-poppins font-normal md:text-xl/[25px] text-base">
                Sales Package
              </p>
              <p className="font-poppins font-normal md:text-xl/[25px] text-base">
                Model Number
            ...
            <span className="flex flex-col gap-7">
              ...
              <span className="space-y-16">
                ...
                <p className="font-poppins font-normal md:text-xl/[25px] text-base pb-[44px]">
                ...
                <p className="font-poppins font-normal md:text-xl/[25px] text-base pt-[104px]">
                  Domestic Warranty
                </p>
              </span>
            </span>
          ...
          <div className="flex flex-col gap-24 sm:border-r border-t border-1 pl-2 lg:pl-10 pt-8 lg:w-[344px] w-auto lg:px-14 px-2">
            ...
            <span className="space-y-7 mt-16">
              ...
              <p className="font-poppins font-normal md:text-xl/[25px] text-base pb-[23px]">
                280 KG
              </p>
              <p className="font-poppins font-normal md:text-xl/[25px] text-base">
                India
            ...
            <span className="flex flex-col gap-7 mt-16 lg:w-56 w-auto">
              ...
              <p className="font-poppins font-normal md:text-xl/[25px] text-base mt-3">
                For Warranty Claims or Any Product Related Issues Please Email
                at operations@trevifurnit ure.com
              </p>
              <p className="font-poppins font-normal md:text-xl/[25px] text-base">
                Warranty Against Manufacturing Defect
              </p>
              <p className="font-poppins font-normal md:text-xl/[25px] text-base mt-14">
              ...
              <p className="font-poppins font-normal md:text-xl/[25px] text-base mt-4">
                1 Year
              </p>
            </span>
          ...
          <div className="flex flex-col gap-24 sm:border-r border-t border-1 pl-2  lg:pl-10 pt-8 lg:w-[344px] w-auto lg:px-20 px-2">
            ...
            <span className="flex flex-col gap-7 mt-[60px] lg:w-56 w-auto ">
              ...
              <p className="font-poppins font-normal md:text-xl/[25px] text-base mt-6">
